...
<div class="container-fluid text-center">    
		...
		<?php
					...
					$tsql="select Om_Recipient_ID,User_Type,R_First_Name,R_Middle_Name,R_Last_Name,R_Age,
						   R_Gender,Referral_User_ID from Recipient_Profile order by Om_Recipient_ID  ;";
					$params = array();
...
<div class="row content">
		...
		<!-- To view Potential Donors Profile-->
		<div class="col-sm-6 text-left"> 
			<h3> Search Potential Donors</h3>
		
		
			 <div id="cnt_form">
					<form 	id="wp-form" 
							class="contact" 
							name="Potential_Donor_search_form"
							method="post" 
							action="organ_match.php">					 
						<div class="form-group">
						
							To view the Potential Donors enter the Recipient's Om Recipient ID:													
							<input  type="text" 
									id="search_recipient_id" 
									name="search_recipient_id"
									class="form-control mail-field input-lg"
