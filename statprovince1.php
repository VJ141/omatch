...
$tsql="SELECT * FROM Donor_Profile WHERE D_Province = '$province'; ";
$params = array();
...
$tsql2="SELECT * FROM Donor_Profile WHERE D_Gender = 'male' AND D_Province = '$province'; ";
$params2 = array();
...
$tsql3="SELECT * FROM Donor_Profile WHERE D_Gender = 'female' AND D_Province = '$province'; ";
$params3 = array();
...
$tsql4="SELECT * FROM Donor_Profile WHERE D_Age < 30 AND D_Province = '$province';";
$params4 = array();
...
$tsql5="SELECT * FROM Donor_Profile WHERE D_Age > 30 AND D_Province = '$province';";
$params5 = array();
...
$tsql51="SELECT * FROM Donor_Profile WHERE D_Blood_Group = 'B+' AND D_Province = '$province';";
$params51 = array();
...
//Fetch number of  donors profile b-ve
$tsql52="SELECT * FROM Donor_Profile WHERE D_Blood_Group = 'B-' AND D_Province = '$province';";
$params52 = array();
...
$tsql53="SELECT * FROM Donor_Profile WHERE D_Blood_Group = 'A+' AND D_Province = '$province';";
$params53 = array();
...
//Fetch number of  donors profile A-ve
$tsql54="SELECT * FROM Donor_Profile WHERE D_Blood_Group = 'A-' AND D_Province = '$province';";
$params54 = array();
...
$tsql55="SELECT * FROM Donor_Profile WHERE D_Blood_Group = 'O-' AND D_Province = '$province';";
$params55 = array();
...
//Fetch number of  donors profile o+ve
$tsql56="SELECT * FROM Donor_Profile WHERE D_Blood_Group = 'O+' AND D_Province = '$province';";
$params56 = array();
...
$tsql57="SELECT * FROM Donor_Profile WHERE D_Blood_Group = 'AB-' AND D_Province = '$province';";
$params57 = array();
...
//Fetch number of  donors profile AB+ve
$tsql58="SELECT * FROM Donor_Profile WHERE D_Blood_Group = 'AB+' AND D_Province = '$province';";
$params58 = array();
...
$tsq6="SELECT * FROM Recipient_Profile WHERE R_Province = '$province'; ";
$params6 = array();
...
$tsql7="SELECT * FROM Recipient_Profile WHERE R_Gender = 'male' AND R_Province = '$province'; ";
$params7 = array();
...
$tsql8="SELECT * FROM Recipient_Profile WHERE R_Gender = 'female' AND R_Province = '$province'; ";
$params8 = array();
...
$tsql9="SELECT * FROM Recipient_Profile WHERE R_Age < 30 AND R_Province = '$province'; ";
$params9 = array();
...
$tsql10="SELECT * FROM Recipient_Profile WHERE R_Age > 30 AND R_Province = '$province'; ";
$params10 = array();
...
$tsql21="SELECT * FROM Recipient_Profile WHERE R_Blood_Group = 'B+' AND R_Province = '$province';";
$params21 = array();
...
//Fetch number of  recipient profile b-ve
$tsql22="SELECT * FROM Recipient_Profile WHERE R_Blood_Group = 'B-' AND R_Province = '$province';";
$params22 = array();
...
$tsql23="SELECT * FROM Recipient_Profile WHERE R_Blood_Group = 'A+' AND R_Province = '$province';";
$params23 = array();
...
//Fetch number of  recipient profile A-ve
$tsql24="SELECT * FROM Recipient_Profile WHERE R_Blood_Group = 'A-' AND R_Province = '$province';";
$params24 = array();
...
<div class="container-fluid text-center ">    
	...
	<div class="row content col-sm-12" style="padding-right:5%;">
		...
		<div class="col-sm-12 text-center"> 
			<h1 style="text-align:center;color:blue;">Statistics of <?php echo $province;?></h1></br></br>
		</div>
	<div class="row content col-sm-12" style="padding-right:5%;">
		...
		<table id="donor_profile_table" class="table  table-striped"> 					<!-- bootstrap table class and striped table class-->
					...
					<tr>
					<th style="color:blue;font-weight:bold;font-size:1em;">Province:</th>
						<td style="color:red;font-weight:bold;font-size:0.8em;"><?php echo $province;?></td>
					</tr>
					<tr>
